class OpengrokPagesController < ApplicationController
  ...
  def index
    ...
    Dir.chdir("/var/lib/tomcat6/webapps/") 
     ...
     @modem_main_infineon << [data[1], data[4]].join('@') if data[0] == "MODEM MAIN INFINEON\n"
     ...
     @params_kk_mapple << [data[1], data[4]].join('@') if data[0] == "Kit-Kat MAIN MAPPLE\n"
     @params_kk_sangria << [data[1], data[4]].join('@') if data[0] == "Kit-Kat MAIN SANGRIA\n"
  end
end 
